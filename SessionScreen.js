...
export default function SessionScreen ( {route, navigation} ) {
    ...
    var [textArray, setTextArray] = useState(['Hero', 'Villain 1', 'Villain 2', 'Villain 3', 'Villain 4', 'Villain 5','Villain 6','Villain 7','Villain 8'])


    var [colorArray, setColorArray] = useState(['blue','blue','blue','blue','blue','blue','blue','blue','blue'])
    ...
    var makeArray = (numP, TA, CA) => { //Num players, text array, and color array respectively
    ...
    var changeArrayText = (ID, butText) => {
